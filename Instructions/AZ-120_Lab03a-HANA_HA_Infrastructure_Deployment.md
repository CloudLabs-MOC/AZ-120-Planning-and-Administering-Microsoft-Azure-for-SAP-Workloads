...
1.  In the Azure portal, navigate to the Microsoft Entra ID blade.

1.  From the Microsoft Entra ID blade, navigate to the **App registrations** blade and then click **+ New registration**:
